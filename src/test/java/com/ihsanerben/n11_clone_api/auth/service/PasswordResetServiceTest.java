...
class PasswordResetServiceTest {
	...
	void setUp() {
		...
		service = new PasswordResetService(
				users, resetTokens, refreshTokens, passwordEncoder, tokenService, emailService, properties);
	}
	...
	void shouldRejectUnknownResetToken() {
		...
		assertThatThrownBy(() -> service.resetPassword(new ResetPasswordRequest("unknown-token", "NewPassword1")))
